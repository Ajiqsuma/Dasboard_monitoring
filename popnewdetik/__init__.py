...
def ekstrak_data():
    ...
    view['empat']= 'Jadwal Imsak Hari Ini di Jakarta dan Sekitarnya, Rabu 27 Maret 2024,  detikNews | 1 jam yang lalu'
    view['lima']= 'Ganjar Gugat Suara Prabowo Nol, Muzani: Yang ke TPS Nggak Dihargai? ,   detikNews | 2 jam yang lalu'
